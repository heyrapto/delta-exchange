  ...
  return (
    <div className="w-full h-full flex flex-col bg-white border border-gray-300 ">
      ...
      <div className="flex flex-col border-b border-gray-300 relative">
        <div className="flex px-4">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-2 text-xs font-medium border-b-2 transition-colors cursor-pointer ${activeTab === tab
        ...
        {activeTab === "Depth" && (
          <div className="px-4 py-2 absolute top-full left-50 right-0 z-10 bg-white">
